                ...
                <div className="grid grid-cols-2 gap-4">
                   <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        className="bg-white/[0.03] border-white/5 text-white h-14 rounded-2xl"
            ...
            <form onSubmit={handleVerify} className="space-y-6 relative z-10">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  maxLength={6}
                  className="bg-white/[0.03] border-white/10 text-white h-20 rounded-3xl text-center text-3xl tracking-[0.6em] font-black focus:ring-brand-500/30"
                />
              </div>
